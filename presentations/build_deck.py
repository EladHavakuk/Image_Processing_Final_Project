...
findings = [
    ...
    ("\u201cCleanest-looking\u201d restoration isn't always best", "Richardson-Lucy looks cleanest but has the worst detection F1 of 3 methods (0.291); tuned Wiener wins on the metric that matters (0.357) despite more visible artifact.", AMBER),
